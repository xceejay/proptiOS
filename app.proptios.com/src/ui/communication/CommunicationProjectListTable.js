...
const CommunicationProjectListTable = () => {
  // ** State
  ...
  useEffect(() => {
    axios
      .get('/apps/communication/project-list', {
        params: {
          q: value
        }
      })
  ...
  return (
    <Card>
      <CardHeader title="Communication's Projects List" />
      <CardContent>
...
export default CommunicationProjectListTable
