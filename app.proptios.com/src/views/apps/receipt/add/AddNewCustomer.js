    ...
    >
      ...
      <Box component='form' sx={{ p: theme => theme.spacing(0, 6, 6) }} onSubmit={handleSubmit(onSubmit)}>
        <FormControl fullWidth sx={{ mb: 5 }}>
          ...
          />
          {errors.name && (
            <FormHelperText sx={{ color: 'error.main' }} id='receipt-name-error'>
              {errors.name.message}
            </FormHelperText>
          )}
        </FormControl>
        <FormControl fullWidth sx={{ mb: 5 }}>
          ...
          />
          {errors.company && (
            <FormHelperText sx={{ color: 'error.main' }} id='receipt-company-error'>
        ...
        <FormControl fullWidth sx={{ mb: 5 }}>
          ...
          />
          {errors.email && (
            <FormHelperText sx={{ color: 'error.main' }} id='receipt-email-error'>
        ...
        <FormControl fullWidth sx={{ mb: 5 }}>
          ...
          />
          {errors.address && (
            <FormHelperText sx={{ color: 'error.main' }} id='receipt-address-error'>
              {errors.address.message}
            </FormHelperText>
          )}
        </FormControl>
        <FormControl fullWidth sx={{ mb: 5 }}>
          <InputLabel id='receipt-country'>Country</InputLabel>
          ...
          />
          {errors.country && (
            <FormHelperText sx={{ color: 'error.main' }} id='receipt-country-error'>
        ...
        <FormControl fullWidth sx={{ mb: 6 }}>
          ...
          />
          {errors.contact && (
            <FormHelperText sx={{ color: 'error.main' }} id='receipt-contact-error'>
