...
| Live staging `/tenants/` crash | Implemented | Reverified fixed on live staging after replacing a stale Vercel frontend deployment that was still serving the older `items.filter(...)` bundle. Current staging now renders the empty-state grid correctly on `/tenants/`. Evidence: [QA-STAGING-REPORT.md](/home/joel/personal/projects/proptiOS/app.proptios.com/docs/qa/QA-STAGING-REPORT.md) |
...
| Communication module no longer uses hardcoded demo issues | Implemented | The communication page now loads real issues from the backend `issues` tables through dedicated `/communication/issues` API routes instead of rendering baked-in demo data. Evidence: [communication.js](/home/joel/personal/projects/proptiOS/api.pm.proptios.com/app/controllers/module/communication.js), [ParentCommunicationViewIssues.js](/home/joel/personal/projects/proptiOS/app.proptios.com/src/ui/communication/ParentCommunicationViewIssues.js), [communication.spec.js](/home/joel/personal/projects/proptiOS/app.proptios.com/e2e/communication.spec.js) |
| Communication reporter/comment author no longer renders `Current User` | Implemented | Reporter and commenter names now come from the persisted issue/comment records returned by the backend, and the communication E2E verifies the live flow using the authenticated user name. Evidence: [communication.js](/home/joel/personal/projects/proptiOS/api.pm.proptios.com/app/controllers/module/communication.js), [ParentCommunicationViewIssues.js](/home/joel/personal/projects/proptiOS/app.proptios.com/src/ui/communication/ParentCommunicationViewIssues.js), [communication.spec.js](/home/joel/personal/projects/proptiOS/app.proptios.com/e2e/communication.spec.js) |
