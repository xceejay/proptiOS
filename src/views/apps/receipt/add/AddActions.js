  ...
  return (
    <Grid container spacing={6}>
      ...
      <Grid item xs={12}>
        ...
        <OptionsWrapper>
          <InputLabel sx={{ cursor: 'pointer' }} htmlFor='receipt-add-payment-terms'>
            Payment Terms
          </InputLabel>
          <Switch defaultChecked id='receipt-add-payment-terms' />
        </OptionsWrapper>
        <OptionsWrapper>
          <InputLabel sx={{ cursor: 'pointer' }} htmlFor='receipt-add-client-notes'>
            Client Notes
          </InputLabel>
          <Switch id='receipt-add-client-notes' />
        </OptionsWrapper>
        <OptionsWrapper>
          <InputLabel sx={{ cursor: 'pointer' }} htmlFor='receipt-add-payment-stub'>
            Payment Stub
          </InputLabel>
          <Switch id='receipt-add-payment-stub' />
        </OptionsWrapper>
      </Grid>
    </Grid>
  )
