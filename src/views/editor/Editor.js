  ...
  return (
    <>
      ...
      {submittedContent ? (
        ...
        <>
          Press “Save” above to show the HTML markup for the editor content. Typically you’d use a similar{' '}
          <code>editor.getHTML()</code> approach to save your data in a form.
        </>
      )}
    </>
  )
