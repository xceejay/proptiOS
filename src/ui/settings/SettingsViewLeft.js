...
import SettingsSuspendDialog from 'src/ui/settings/SettingsSuspendDialog'
import SettingsSubscriptionDialog from 'src/ui/settings/SettingsSubscriptionDialog'
...
const SettingsViewLeft = ({ settingsData }) => {
        ...
        <Grid item xs={12}>
          ...
          <Card>
            <CardContent sx={{ pt: 13.5, display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
              {settingsData.id ? (
                ...
                <CustomAvatar
                  skin='light'
                  variant='rounded'
                  color={settingsData.avatarColor}
                  sx={{ width: 100, height: 100, mb: 4, fontSize: '3rem' }}
                >
                  {getInitials(settingsData.name)}
                </CustomAvatar>
              )}
              ...
              <CustomChip
                ...
                skin='light'
                size='small'
                label={settingsData.status}
                color={statusColors[settingsData.status]}
            ...
            <CardContent sx={{ pb: 4 }}>
              ...
              <Box sx={{ pt: 4 }}>
                <Box sx={{ display: 'flex', mb: 3 }}>
                  <Typography sx={{ mr: 2, fontWeight: 500 }}>Settings ID:</Typography>
                  <Typography sx={{ color: 'text.secondary' }}>{settingsData.uuid} </Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 3 }}>
                  <Typography sx={{ mr: 2, fontWeight: 500 }}>Email:</Typography>
                  <Typography sx={{ color: 'text.secondary' }}>{settingsData.email}</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 3 }}>
                ...
                <Box sx={{ display: 'flex', mb: 3 }}>
                  ...
                  <Typography sx={{ color: 'text.secondary', textTransform: 'capitalize' }}>
                    {settingsData.property.name}
                  </Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 3 }}>
                  <Typography sx={{ mr: 2, fontWeight: 500 }}>Total Units :</Typography>
                  <Typography sx={{ color: 'text.secondary' }}>{settingsData.units.length}</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 3 }}>
                  <Typography sx={{ mr: 2, fontWeight: 500 }}>Contact:</Typography>
                  <Typography sx={{ color: 'text.secondary' }}>{settingsData.tel_number}</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 3 }}>
                ...
                <Box sx={{ display: 'flex' }}>
                  ...
                  <Typography sx={{ color: 'text.secondary' }}>{settingsData.country}</Typography>
                </Box>
              </Box>
            </CardContent>
            ...
            <Dialog
              ...
              aria-labelledby='settings-view-edit'
              aria-describedby='settings-view-edit-description'
              sx={{ '& .MuiPaper-root': { width: '100%', maxWidth: 650 } }}
            >
              <DialogTitle
                id='settings-view-edit'
                sx={{
                  textAlign: 'center',
              ...
              >
                <DialogContentText
                  variant='body2'
                  id='settings-view-edit-description'
                  sx={{ textAlign: 'center', mb: 7 }}
                >
                  Updating settings details will receive a privacy settings.
                </DialogContentText>
                <form>
                  <Grid container spacing={6}>
                    ...
                    <Grid item xs={12} sm={6}>
                      <TextField
                        fullWidth
                        label='Settings ID'
                        defaultValue={settingsData.uuid}
                        disabled
                    ...
                    <Grid item xs={12} sm={6}>
                      <FormControl fullWidth>
                        ...
                        <Select
                          label='Status'
                          defaultValue={settingsData.status}
                          id='settings-view-status'
                          labelId='settings-view-status-label'
                          disabled
                        >
                    ...
                    <Grid item xs={12} sm={6}>
                      <FormControl fullWidth>
                        ...
                        <Select
                          ...
                          labelId='settings-view-language-label'
                        >
                    ...
                    <Grid item xs={12} sm={6}>
                      <FormControl fullWidth>
                        ...
                        <Select
                          ...
                          id='settings-view-country'
                          disabled
                          labelId='settings-view-country-label'
                        >
            ...
            <SettingsSuspendDialog open={suspendDialogOpen} setOpen={setSuspendDialogOpen} />
            <SettingsSubscriptionDialog open={subscriptionDialogOpen} setOpen={setSubscriptionDialogOpen} />
          </Card>
        </Grid>
        ...
        <Grid item xs={12}>
          <Card>
            ...
            {/* <CardContent>
              <Box sx={{ mt: 2.5, mb: 4 }}>
                <Box sx={{ display: 'flex', mb: 2, alignItems: 'center', '& svg': { mr: 2, color: 'text.secondary' } }}>
                  ...
                  <Typography sx={{ color: 'text.secondary' }}>10 Settings</Typography>
                </Box>
            ...
            <Dialog
              ...
              aria-labelledby='settings-view-plans'
              aria-describedby='settings-view-plans-description'
              sx={{ '& .MuiPaper-root': { width: '100%', maxWidth: 650 } }}
            >
              <DialogTitle
                id='settings-view-plans'
                sx={{
                  textAlign: 'center',
                  fontSize: '1.5rem !important',
                  px: theme => [`${theme.spacing(5)} !important`, `${theme.spacing(15)} !important`],
              ...
              >
                <DialogContentText variant='body2' sx={{ textAlign: 'center' }} id='settings-view-plans-description'>
                  Choose the best plan for the settings.
                </DialogContentText>
              </DialogContent>
              ...
              >
                <FormControl fullWidth size='small' sx={{ mr: [0, 3], mb: [3, 0] }}>
                  <InputLabel id='settings-view-plans-select-label'>Choose Plan</InputLabel>
                  <Select
                    label='Choose Plan'
                    defaultValue='Standard'
                    id='settings-view-plans-select'
                    labelId='settings-view-plans-select-label'
                  >
              ...
              >
                <Typography sx={{ fontWeight: 500, mb: 2, fontSize: '0.875rem' }}>
                  Settings current plan is standard plan
                </Typography>
                <Box
                  sx={{
                    display: 'flex',
...
export default SettingsViewLeft
