...
import AuditTransactionListTable from 'src/ui/audit/AuditTransactionListTable'
...
const AuditViewTransactions = ({ auditData }) => {
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        {/* <AuditProjectListTable></AuditProjectListTable> */}
      </Grid>
      {/* <Grid item xs={12}>
        <Card>
          <CardHeader
      ...
      <Grid item xs={12}>
        <AuditTransactionListTable auditTransactionData={auditData.transactions} />
      </Grid>
    </Grid>
  )
}

export default AuditViewTransactions
