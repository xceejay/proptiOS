...
const AuditViewSecurity = () => {
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Card>
          <CardHeader title='Reset Audit Password' />
          <CardContent>
            <Alert
              icon={false}
              severity='error'
            ...
            >
              <AlertTitle>This should be done only when instruction comes directly from the audit</AlertTitle>A reset
              password link would be sent to the audit clicking the button below.
            </Alert>
            <form onSubmit={e => e.preventDefault()}>
              <Grid container mt={2} spacing={4}>
                {/* <Grid item xs={12} sm={6}>
                  <FormControl fullWidth>
                    <InputLabel htmlFor='audit-view-security-new-password'>New Password</InputLabel>
                    <OutlinedInput
                      label='New Password'
                      value={values.newPassword}
                      id='audit-view-security-new-password'
                ...
                <Grid item xs={12} sm={6}>
                  <FormControl fullWidth>
                    <InputLabel htmlFor='audit-view-security-confirm-new-password'>Confirm New Password</InputLabel>
                    <OutlinedInput
                      label='Confirm New Password'
                      value={values.confirmNewPassword}
                      id='audit-view-security-confirm-new-password'
      ...
      {/* <Grid item xs={12}>
        <Card>
          ...
          <Dialog
            ...
            aria-labelledby='audit-view-security-edit-mobile-number'
            sx={{ '& .MuiPaper-root': { width: '100%', maxWidth: 650 } }}
            aria-describedby='audit-view-security-edit-mobile-number-description'
          >
            <DialogTitle
              id='audit-view-security-edit-mobile-number'
              sx={{
                textAlign: 'center',
...
export default AuditViewSecurity
