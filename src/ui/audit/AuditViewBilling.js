          ...
          <CardContent>
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'flex-start' }}>
                <Button size="small" variant='contained' onClick={handleUpgradePlansClickOpen} sx={{ mr: 4, mb: [2, 0] }}>
                  Upgrade Plan
                </Button>
          ...
          >
            ...
            >
              ...
              >
                ...
                <Button size="small" color='error' variant='outlined' sx={{ mt: 2 }} onClick={() => setSubscriptionDialogOpen(true)}>
                  Cancel Subscription
                </Button>
              </Box>
            </DialogContent>
      ...
      <Grid item xs={12}>
        <Card>
          ...
          <Dialog
            ...
            aria-labelledby='audit-view-billing-edit-card'
            sx={{ '& .MuiPaper-root': { width: '100%', maxWidth: 650 } }}
            aria-describedby='audit-view-billing-edit-card-description'
          >
            <DialogTitle
              id='audit-view-billing-edit-card'
              sx={{
                textAlign: 'center',
                fontSize: '1.5rem !important',
                px: theme => [`${theme.spacing(5)} !important`, `${theme.spacing(15)} !important`],
            ...
            >
              <DialogContentText
                variant='body2'
                id='audit-view-billing-edit-card-description'
                    ...
                    <Grid container spacing={6}>
                      ...
                      <Grid item xs={12} sm={8}>
                        <FormControl fullWidth>
                          <InputLabel id='audit-view-billing-edit-card-status-label'>Card Status</InputLabel>
                          <Select
                            label='Card Status'
                            id='audit-view-billing-edit-card-status'
                            labelId='audit-view-billing-edit-card-status-label'
      ...
      <Grid item xs={12}>
        <Card>
          ...
          <Dialog
            ...
            aria-labelledby='audit-address-edit'
            sx={{ '& .MuiPaper-root': { width: '100%', maxWidth: 650 } }}
            aria-describedby='audit-address-edit-description'
          >
            <DialogTitle
              id='audit-address-edit'
              sx={{
                textAlign: 'center',
                fontSize: '1.5rem !important',
                px: theme => [`${theme.spacing(5)} !important`, `${theme.spacing(15)} !important`],
            ...
            >
              <DialogContentText
                variant='body2'
                id='audit-address-edit-description'
                sx={{ textAlign: 'center', mb: 7 }}
              >
...
export default AuditViewBilling
