...
import { schema, Header } from './AddAuditDrawer'
import toast from 'react-hot-toast'

export const SidebarAddAudit = props => {
  ...
  const onSubmit = data => {
    ...
    audit.addAudit(
      ...
      responseData => {
        ...
        setAuditData(data)
        console.log('FROM Audit drawer PAGE:', data)

        if (data?.status === 'NO_RES') {
          console.log('NO results')
        } else if (data?.status === 'FAILED') {
          alert(data.message || 'Failed to add audit')
