...
const AuditTransactionListTable = ({ auditTransactionData }) => {
  // ** State
    ...
    <Grid container spacing={6.5}>
        ...
        action={
          <>
            <Button
              ...
              aria-controls={open ? 'audit-view-overview-export' : undefined}
            >
              Export
            </Button>
            <Menu open={open} anchorEl={anchorEl} onClose={handleClose} id='audit-view-overview-export'>
      ...
      /> */}
          <DataGrid
            ...
            columns={columns}
            loading={false}
            slots={{ toolbar: CustomAuditToolbar }}
            rows={auditTransactionData}
...
export default AuditTransactionListTable
