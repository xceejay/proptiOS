...
export const fetchMails = createAsyncThunk('appEmail/fetchMails', async params => {
  const response = await axios.get(process.env.NEXT_PUBLIC_API_BASE_URL + '/apps/email/emails', {
    params
  })
...
export const getCurrentMail = createAsyncThunk('appEmail/selectMail', async id => {
  const response = await axios.get(process.env.NEXT_PUBLIC_API_BASE_URL + '/apps/email/get-email', {
    params: {
      id
    }
  })
...
export const paginateMail = createAsyncThunk('appEmail/paginateMail', async params => {
  const response = await axios.get(process.env.NEXT_PUBLIC_API_BASE_URL + '/apps/email/paginate-email', { params })
