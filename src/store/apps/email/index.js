...
export const fetchMails = createAsyncThunk('appEmail/fetchMails', async params => {
  const response = await axios.get('https://api.pm.manages.homes/apps/email/emails', {
    params
  })
...
export const getCurrentMail = createAsyncThunk('appEmail/selectMail', async id => {
  const response = await axios.get('https://api.pm.manages.homes/apps/email/get-email', {
    params: {
      id
    }
  })
...
export const paginateMail = createAsyncThunk('appEmail/paginateMail', async params => {
  const response = await axios.get('https://api.pm.manages.homes/apps/email/paginate-email', { params })
